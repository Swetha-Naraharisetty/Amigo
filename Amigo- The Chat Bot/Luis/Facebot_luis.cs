...
namespace Amigo__The_Chat_Bot
{
    ...
    public class Amigo_Luis : LuisDialog<object>
    {
        ...
        {
            Amigo_Luis face = new Amigo_Luis();
            var path = Path.Combine(@"C:\Users\sai vaishnavi\Documents\Visual Studio 2017\Projects\Amigo\Amigo- The Chat Bot\Amigo- The Chat Bot\Data\fear.txt");
            Random r = new Random();
        ...
        public async Task sad(IDialogContext context, LuisResult result)
        {
            ...
            if(option == 0)
            {
                var path = Path.Combine(@"C:\Users\sai vaishnavi\Documents\Visual Studio 2017\Projects\Amigo\Amigo- The Chat Bot\Amigo- The Chat Bot\Data\JokesWithImages.txt");
            ...
            {
                var path = Path.Combine(@"C:\Users\sai vaishnavi\Documents\Visual Studio 2017\Projects\Amigo\Amigo- The Chat Bot\Amigo- The Chat Bot\Data\JokesWithoutImages.txt");
            ...
            {
                var path = Path.Combine(@"C:\Users\sai vaishnavi\Documents\Visual Studio 2017\Projects\Amigo\Amigo- The Chat Bot\Amigo- The Chat Bot\Data\ImagesJokes.txt");
